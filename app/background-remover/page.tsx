...
import { BackgroundRemoverHub } from '@/components/background-remover/BackgroundRemoverHub';
        ...
        <Suspense
          fallback={
            <div className="flex min-h-[50vh] items-center justify-center">
              <div className="text-xs text-zinc-400">Memuat AI Background Remover...</div>
            </div>
          }
        >
          <BackgroundRemoverHub />
        </Suspense>
      </main>
